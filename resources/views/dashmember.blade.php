        ...
        <div class="main-header bg-primary">
            ...
            <nav class="navbar navbar-header navbar-expand-lg bg-primary">
                <div class="container-fluid">
                    <div class="navbar-left mt-2 navbar-form nav-search mr-md-3" id="searchForm">
            ...
            <ul class="nav">
                <li class="nav-item">
                    <a href="#" style="background-color: #a27bd8;">
                        <img src="assets/img/cari.png" width="25" style="margin-right: 10px; margin-top: 20px;" alt="">
                        <span style="color: white; margin-top: 20px;">Pencarian</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/dashkategori') }}" style="margin-top: 10px;">
                        <img src="assets/img/ebook.png" width="25" style="margin-right: 10px;">
                        <span style="color: white;">Kategori</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/formdatapinjam') }}" style="margin-top: 10px;">
                        <img src="assets/img/pinjam.png" width="25" style="margin-right: 10px;">
                        <span style="color: white;">Peminjaman</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/bantuanpengunjung') }}" style="margin-top: 10px;">
                    ...
                    <div class="modal-body">
                        <div class="row d-flex align-items-center padding-warning">
                            <div class="col-md-4 text-center">
                                <img src="assets/img/tidak.png" width="150px">
                            </div>
                            <div class="col-md-8">
                                <h4 class="text-black"><b>Maaf! Buku yang anda cari tidak tersedia</h4>
                            </div>
                        </div>
                    </div>
                </div>
