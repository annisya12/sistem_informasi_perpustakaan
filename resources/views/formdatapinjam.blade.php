        ...
        <div class="formulir">
            <form action="{{ route('store.submit') }}" method="POST">
                ...
                <div class="w-75 m-auto mt-5">
                    ...
                    <input type="date" name="Tgl_Peminjaman" class="form-control" id="exampleInputTglPeminjaman" onchange="updateEndDate()" required>
                </div>
                <div class="w-75 m-auto mt-5">
                    <label for="exampleInputTglPeminjamanEnd" class="form-label">Tanggal Akhir Peminjaman</label>
                    <input type="date" name="Tgl_Peminjaman_End" class="form-control" id="exampleInputTglPeminjamanEnd" readonly required>
                </div>
                <div class="w-75 m-auto mt-5">
